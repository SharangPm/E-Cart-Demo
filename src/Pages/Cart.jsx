        ...
        <div className="col-lg-1"></div>
          <div className="col-lg-3">
            <div className="card shadow rounded mt-5 p-5">
              ...
              <h3>Total Price : <span className='text-danger fw-bolder'>$1000</span></h3>
            </div>
